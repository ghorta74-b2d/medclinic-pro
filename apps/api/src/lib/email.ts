  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr><td align="center">
      ...
      <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 2px 24px rgba(0,0,0,0.08);max-width:100%">
        ...
        <tr>
          <td style="padding:40px 40px 32px">
            <p style="margin:0 0 8px;font-size:24px;font-weight:600;color:#111827;letter-spacing:-0.3px">${greeting}</p>
            <p style="margin:0 0 32px;font-size:15px;color:#6b7280;line-height:1.7">Recibimos una solicitud para restablecer la contraseña de tu cuenta en <strong>Mediaclinic</strong>. Haz clic en el botón para crear una nueva contraseña:</p>
              ...
              <tr>
                <td style="padding:20px 24px">
                  ...
                  <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.6">
                    Si no solicitaste cambiar tu contraseña, puedes ignorar este correo. Tu cuenta sigue segura.
                  </p>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:24px 0 0;font-size:12px;color:#9ca3af;line-height:1.7">
              ...
              <a href="${opts.resetLink}" style="color:#0071e3;word-break:break-all">${opts.resetLink}</a>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:20px 40px 28px;border-top:1px solid #f3f4f6;text-align:center">
            <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.7">
              ...
              Si no esperabas este correo, puedes ignorar este mensaje.
            </p>
          </td>
        </tr>
